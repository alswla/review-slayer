...
각 리뷰 역할마다 메인 / 서브 캐릭터 중 선택할 수 있습니다.
...
flowchart TB
    ...
    subgraph D["⚔️ CrewAI 주 에이전트 — 병렬 리뷰"]
        D1["🦋 보안"]
        D2["⚡ 성능"]
        D3["🐍 품질"]
        D4["🪨 설계"]
...
> **설정 파일이 없으면?** 핵심 5개 역할(Security, Performance, Code Quality, Architecture, Bug Detection)이 메인 캐릭터로 자동 실행됩니다.
